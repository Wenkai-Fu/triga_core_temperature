...
d0 = np.loadtxt('may_17_tmpdata_0.dat')
d1 = np.loadtxt('may_17_tmpdata_1.dat')
d2 = np.loadtxt('may_17_tmpdata_2.dat')
d3 = np.loadtxt('may_17_tmpdata_3.dat')

data = np.concatenate((d0, d1, d2, d3), 0)
